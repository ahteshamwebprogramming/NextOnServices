<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddSupplier.aspx.cs" EnableEventValidation="false" Inherits="AddSupplier" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtCNumber" runat="server" class="form-control" onkeypress="return isNumberKey(event)" MaxLength="12" placeholder="00 999 9999"></asp:TextBox>
                                        ...
                                        <%-- <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <select id="ddlTrackingType" class="form-control" onchange="SectionSelect()">
                                                    <option value="0">Redirects</option>
                                                    <option value="1">Pixel Tracking</option>
                                                </select>

                                            </div>
                                        </div>--%>
                                        <div id="Section_Redirects">
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <span class="help-block" style="color: orange">https://www.abcdefgh.aspx?RIS=20&RID=[respondentID]</span>
                                                </div>
                                            </div>
                                            <%-- <div class="col-xs-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <asp:Button ID="btnSubmit" runat="server" class="btn btn-success btn-anim" OnClientClick="return validation();"
                                                    Text="Save & Next" OnClick="btnSubmit_Click" />
