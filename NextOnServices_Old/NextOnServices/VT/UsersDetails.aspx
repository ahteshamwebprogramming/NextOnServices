...
<body>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-default card-view">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark">Users Details</h6>
                                    </div>
    ...
    <script src="../Scripts/assets/jquery-ui.js"></script>
    ...
    <script type="text/javascript">
        ...
        function GetUserDetails() {
            $.ajax({
                ...
                url: 'UsersDetails.aspx/GetUserDetails',
                cache: false,
                dataType: "json",
                success: function (data) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                        ...
                        tbody += '<tr><td><a href="UserProfile.aspx?ID=' + data.d[i].ID + '" class="hover_blue">' + data.d[i].Name + '</td><td>' + data.d[i].Email + '</td><td>' + data.d[i].Number + '</td><td><input type="button" value="Edit" class="btn btn-success samewidth" onclick=EDIT("' + data.d[i].ID + '") /></td>' + active + '</tr>';
