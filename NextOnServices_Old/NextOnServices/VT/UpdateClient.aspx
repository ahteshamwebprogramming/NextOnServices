<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateClient.aspx.cs" Inherits="UpdateClient" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function validation() {
            ...
            if (txtCN.value == '') {
                alertt('','Company name cannot left blank','error');
                document.getElementById('txtCN').focus();
                return false;
            }
            if (txtCP.value == '') {
                alertt('','Contact Person cannot be left blank','error');
                    ...
                    <div class="row heading-bg">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><span>Update Client</span></li>
                            </ol>
                        </div>
                        <!-- /Breadcrumb -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Client / Company Name</label>
                                                <asp:TextBox ID="txtCN" runat="server" class="form-control" placeholder="Client Name"></asp:TextBox>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Contact Person</label>
                                                <asp:TextBox ID="txtCP" runat="server" class="form-control" placeholder="Contact Person"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtCNumber" runat="server" data-mask="(999) 999-9999" MaxLength="12" class="form-control" placeholder="(999) 999-9999"></asp:TextBox>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Contact Email</label>
