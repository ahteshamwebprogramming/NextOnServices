                    ...
                    <div class="row heading-bg">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><span>Add Client</span></li>
                            </ol>
                        </div>
                        <!-- /Breadcrumb -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtCN" runat="server" class="form-control" placeholder="Enter your Name / Company Name"></asp:TextBox>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtCNumber" runat="server" onkeypress="return isNumberKey(event)" MaxLength="12" class="form-control" placeholder="999 999 9999"></asp:TextBox>
