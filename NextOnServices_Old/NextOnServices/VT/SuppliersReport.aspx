<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuppliersReport.aspx.cs" Inherits="SuppliersReport" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            //json for getting suppliers
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: 'OverallReport.aspx/GetSuppliers',
                cache: false,
                dataType: "json",
                success: function (data) {
                    if (data.d.length > 0) {
            ...
            $('#btnSubmit').click(function () {
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({ CountryId: countryid, Clientid: 0, Supplierid: supplierid, sdate: $('#txtSDate').val(), edate: $('#txtEDate').val() }),
                    cache: false,
                    dataType: "json",
                    success: function (data) {
                        jQuery.unblockUI();
