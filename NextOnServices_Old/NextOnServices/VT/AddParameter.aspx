<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddParameter.aspx.cs" Inherits="VT_AddParameter" %>
...
<body>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <select name="Project" class="form-control dropdown search">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Include in Supplier</label>
                                                <select class="form-control" name="IncludeInSupplier">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <button type="button" class="btn btn-success btn-anim" name="Submit"><i class="icon-rocket"></i><span class="btn-text">submit</span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="../CustomJS/AddParameter.js"></script>
    <script type="text/javascript">
        jQuery.noConflict();
        //function alertt()
        //{
