<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplierDetails.aspx.cs" Inherits="SupplierDetails" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        function openWindow(code) {
            window.open('SupplierPopReport.aspx?Id=' + code, 'open_window', ' width=1000, height=600, left=100, top=30');
        }
    </script>
    <style>
        table thead tr th {
                    ...
                    <div class="row heading-bg">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><span>Supplier List</span></li>
                            </ol>
                        </div>
                        <!-- /Breadcrumb -->
    ...
    <script type="text/javascript">
        ...
        function GetSuppliers() {
            $.ajax({
                ...
                url: 'SupplierDetails.aspx/GetSuppliersDetails',
                cache: false,
                dataType: "json",
                success: function (data) {
                    ...
                    for (var i = 0; i < data.d.length; i++) {
                        ...
                        tbody += '<tr><td><a href="SupplierPopReport.aspx?ID=' + data.d[i].ID + '" class="hover_blue">' + data.d[i].Name + '</a></td><td>' + data.d[i].Description + '</td><td>' + data.d[i].Number + '</td><td>' + data.d[i].Email + '</td><td>' + data.d[i].PSize + '</td><td>' + data.d[i].Country + '</td><td><input type="button" value="Edit" class="btn btn-success samewidth"  onclick=EDITP("' + data.d[i].ID + '") /></td><td><input type="button" class="btn btn-success samewidth"  value="Edit" onclick=EDIT("' + data.d[i].ID + '") /></td>' + active + '</tr>';
        ...
        function EDITP(id) {
            var url = "SupplierCountryPanelSize.aspx?SID=" + id;
            window.location.href = url;
        }
        function Active(id) {
            var message;
            ...
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: 'SupplierDetails.aspx/Delete',
