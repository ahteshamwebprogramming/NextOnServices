...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function validation() {
            ...
            if (txtUN.value == '') {
                alertt('','User name cannot left blank','error');
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtUserid" runat="server" ReadOnly="true" class="form-control" placeholder="Enter User Name"></asp:TextBox>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtCN" runat="server" class="form-control" MaxLength="12" onkeypress="return isNumberKey(event)" placeholder="Enter your Number"></asp:TextBox>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtAdd" runat="server" class="form-control" placeholder="Enter your notes here" TextMode="MultiLine" Rows="4"></asp:TextBox>
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <asp:Button ID="btnSubmit" runat="server" class="btn btn-success btn-anim" onkeypress="return isNumberKey(event)" OnClientClick="return validation();" Text="Update" OnClick="btnSubmit_Click" />
