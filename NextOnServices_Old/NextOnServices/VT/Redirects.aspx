<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Redirects.aspx.cs" Inherits="Redirects" %>
...
<body>
                                    ...
                                    <div class="row" id="redirects">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <label class="form-control lbl">https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=TERMINATE&RC=0</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Overquota</label>
                                                <label class="form-control lbl">https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=OVERQUOTA&RC=0</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Security Term</label>
                                                <label class="form-control lbl" style="background-color: lightblue">https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=SEC_TERM&RC=0</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <br />
                                                <label class="lbl form-control">https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=F_ERROR&RC=0</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Variable 1</label>
                                                <label class="form-control lbl">https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=Variable1&RC=0</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Variable 2</label>
                                                <label class="form-control lbl">https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=Variable2&RC=0</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <h6>For pixel tracking</h6>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Completes</label>
                                                <label class="form-control lbl">&lt;iframe src="https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=COMPLETE&RC=0&PX=1" scrolling="no" frameborder="0" width="1" height="1"&gt;&lt;/iframe&gt;</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Terminate</label>
                                                <label class="form-control lbl">&lt;iframe src="https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=TERMINATE&RC=0&PX=1" scrolling="no" frameborder="0" width="1" height="1"&gt;&lt;/iframe&gt;</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Overquota</label>
                                                <label class="form-control lbl">&lt;iframe src="https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=OVERQUOTA&RC=0&PX=1" scrolling="no" frameborder="0" width="1" height="1"&gt;&lt;/iframe&gt;</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label class="control-label mb-10">Security Term</label>
                                                <label class="form-control lbl">&lt;iframe src="https://nexton.us/VT/ProjectStatus.aspx?ID=[respondentID]&Status=SEC_TERM&RC=0&PX=1" scrolling="no" frameborder="0" width="1" height="1"&gt;&lt;/iframe&gt;</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="form-group">
    ...
    <script src="../CustomJS/Redirects.js"></script>
</body>
</html>
