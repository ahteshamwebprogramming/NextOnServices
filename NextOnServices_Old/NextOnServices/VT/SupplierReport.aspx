<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupplierReport.aspx.cs" Inherits="SupplierReport" %>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row heading-bg">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h5 class="txt-dark">Supplier Report</h5>
                        </div>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><span>Supplier Report</span></li>
                            </ol>
                        </div>
                        <!-- /Breadcrumb -->
            ...
            $("#btnSubmit").click(function () {
                ...
                if (stats == 'S') {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        //url: 'SupplierReport.aspx/GetSupplierProjectStatus?FDate=' + FDate + '&TDate=' + TDate + '&CountryID=' + country,
                        url: 'SupplierReport.aspx/GetSupplierProjectStatus',
                        data: JSON.stringify({ FDate: SDate, TDate: EDate, CountryID: country }),
                        cache: false,
                        dataType: "json",
                        ...
                        success: function (data) {
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                ...
                                tbody += '<tr><td>' + data.d[i].Suppliers + '</td><td>' + data.d[i].Total + '</td><td>' + data.d[i].Closed + '</td><td>' + data.d[i].InProgress + '</td><td>' + data.d[i].OnHold + '</td><td>' + data.d[i].Cancelled + '</td></tr>';
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        //url: 'SupplierReport.aspx/GetSupplierProjectStatus?FDate=' + FDate + '&TDate=' + TDate + '&CountryID=' + country,
                        url: 'SupplierReport.aspx/GetSupplierProjectRespondents',
                        data: JSON.stringify({ FDate: SDate, TDate: EDate, CountryID: country }),
                        cache: false,
                        dataType: "json",
                        ...
                        success: function (data) {
                            ...
                            for (var i = 0; i < data.d.length; i++) {
                                ...
                                tbody += '<tr><td>' + data.d[i].Suppliers + '</td><td>' + data.d[i].Total + '</td><td>' + data.d[i].Completes + '</td><td>' + data.d[i].Incompletes + '</td><td>' + data.d[i].Screened + '</td><td>' + data.d[i].Quotafull + '</td></tr>';
                                //$("#myTable1 tbody").append('<tr><td>' + data.d[i].Company + '</td><td>' + data.d[i].Person + '</td><td>' + data.d[i].Number + '</td><td>' + data.d[i].Email + '</td><td>' + data.d[i].Country + '</td></tr>')
                            }
