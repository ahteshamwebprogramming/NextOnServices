...
public partial class NextOnServicesContext : DbContext
{
    public NextOnServicesContext()
    {
    }

    public NextOnServicesContext(DbContextOptions<NextOnServicesContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ProjectMapping>(entity =>
        {
            ...
            entity.Property(e => e.OverQuota1).HasColumnName("OVER QUOTA");
            entity.Property(e => e.ParameterName).HasMaxLength(50);
            entity.Property(e => e.ProjectId).HasColumnName("ProjectID");
            entity.Property(e => e.QualityTermination).HasColumnName("QUALITY TERMINATION");
