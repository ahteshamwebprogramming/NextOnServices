...
[Dapper.Contrib.Extensions.Table("ZampliaSetting")]
public class ZampliaSetting
{
...
[Dapper.Contrib.Extensions.Table("ZampliaSyncLog")]
public class ZampliaSyncLog
{
    [Dapper.Contrib.Extensions.Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
...
[Dapper.Contrib.Extensions.Table("ZampliaSurvey")]
public class ZampliaSurvey
{
    [Dapper.Contrib.Extensions.Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
...
[Dapper.Contrib.Extensions.Table("ZampliaSurveyQualification")]
public class ZampliaSurveyQualification
{
    [Dapper.Contrib.Extensions.Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
...
[Dapper.Contrib.Extensions.Table("ZampliaSurveyQuota")]
public class ZampliaSurveyQuota
{
    [Dapper.Contrib.Extensions.Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    public int Id { get; set; }
...
[Dapper.Contrib.Extensions.Table("ZampliaProjectMap")]
public class ZampliaProjectMap
{
    [Dapper.Contrib.Extensions.Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    public int Id { get; set; }
...
[Dapper.Contrib.Extensions.Table("ZampliaEntryLink")]
public class ZampliaEntryLink
{
    [Dapper.Contrib.Extensions.Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    public int Id { get; set; }
...
[Dapper.Contrib.Extensions.Table("ZampliaRespondentAttempt")]
public class ZampliaRespondentAttempt
{
    [Dapper.Contrib.Extensions.Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    public int Id { get; set; }
...
[Dapper.Contrib.Extensions.Table("ZampliaReconciliationRun")]
public class ZampliaReconciliationRun
{
    [Dapper.Contrib.Extensions.Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    public int Id { get; set; }
...
[Dapper.Contrib.Extensions.Table("ZampliaReconciliationItem")]
public class ZampliaReconciliationItem
{
    [Dapper.Contrib.Extensions.Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
    public int Id { get; set; }
